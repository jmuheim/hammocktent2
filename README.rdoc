...
- Replace all occurrences of <code>HammockTent2::Application</code> with <code>PROJECT::Application</code> (e.g. <code>PrettyCalc::Application</code>), every occurrence of <code>module HammockTent2</code> with <code>module PROJECT</code> (e.g. <code>module PrettyCalc</code>), and every occurrence of <code>HammockTent2::</code> with <code>PROJECT::</code> (e.g. <code>PrettyCalc::</code>)
