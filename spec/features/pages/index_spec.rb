...
describe 'Listing pages' do
  ...
  it 'displays pages' do
    ...
    expect(page).to have_title 'Pages - HammockTent 2.0'
    expect(page).to have_active_navigation_items 'Pages', 'List of Pages'
    expect(page).to have_breadcrumbs 'HammockTent 2.0', 'Pages'
  ...
  it 'offers an ATOM feed' do
    ...
    within 'entry:nth-of-type(1)' do
      ...
      within 'content' do
        ...
        expect(page).to have_content '<ol><li><a href="/en">HammockTent 2.0</a></li><li><a href="/en/pages/1">Page test navigation title</a></li></ol>'
    ...
    within 'entry:nth-of-type(2)' do
      ...
      within 'content' do
        expect(page).to have_content '<ol><li><a href="/en">HammockTent 2.0</a></li><li><a href="/en/pages/1">Page test navigation title</a></li><li><a href="/en/pages/2">Page test navigation title</a></li></ol>'
      end
    end
  end
end
