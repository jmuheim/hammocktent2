...
describe PageTitleAndHeadlineHelper do
  describe '#headline_with_flash' do
    describe 'no params given' do
      ...
      it { should have_content 'Welcome to HammockTent 2.0!' }
    end
  ...
  describe '#title_tag' do
    ...
    context 'on other path' do
      ...
      it { should eq '<title>This is the title - HammockTent 2.0</title>' }
    end
    ...
    context 'with flash' do
      ...
      it { should eq '<title>Alert: This is an alert! Notice: This is a notice! This is the title - HammockTent 2.0</title>' }
    end
    ...
    context 'with prefixes' do
      ...
      it { should eq '<title>This is another prefix - This is a first prefix - This is the title - HammockTent 2.0</title>' }
    end
  end
end
